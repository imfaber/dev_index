...
*
*  'sitedir' => array( 'display_name' => 'Display Name', 'admin_url' => 'http://example.sites.dev/admin' ),
*
*/
$site_options = array(
	'dir_name' => array(
	...
	'dir_name' => array(
		...
		'vhost_url' => 'http://display_name.local/'
	)
);
...
*
*/
$hidden_sites = array( 'dev_index', 'favicon.ico');
